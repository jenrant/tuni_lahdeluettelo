...
<xsl:stylesheet version="1.0"
    ...
    <xsl:variable name="data">
        ...
        <general>
            ...
            <version>2023.09.1</version>
            <version2013>2023.091</version2013>
        ...
        <bibliography>
            ...
            <source type="JournalArticle">
                <column id="1">
                    <halign>left</halign>
                    <valign>top</valign>
                    <format>{%Author:3|Editor:4%{ %Year:r%{%YearSuffix%}.}{ %Title|ShortTitle%.}{ %Medium%.}{ %City%:}
                        { %Publisher%{{ %Day%.}%Month%.{%Year%}}{ %Issue%}{, %Pages%}.}
                        { Viitattu {{%DayAccessed%}.%MonthAccessed%}.%YearAccessed%.}{ DOI: %DOI%.}{ %Comments%.}{ &lt;u&gt;%URL:l%&lt;/u&gt;}}</format>
                </column>
                <sortkey>{%Author:0|Editor:0|Title|ShortTitle%}{%Year%}{%Title|ShortTitle%}</sortkey>
            </source>
  ...
  -->
    ...
    <!-- Retrieves the substring of a string after the last occurrence of a symbol. -->
    ...
    <!-- Retrieves the substring of a string before the last occurrence of a symbol. -->
