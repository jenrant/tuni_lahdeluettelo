...
<!-- TOC -->
  ...
  * [Esimerkkejä käytöstä](#esimerkkejä-käytöstä)
    ...
    * [Julkaisusarjoissa julkaisut](#julkaisusarjoissa-julkaisut)
    * [Lait ja asetukset](#lait-ja-asetukset)
    * [Konferenssi-, seminaari- ja muut asiantuntijaesitelmät ja -luennot](#konferenssi--seminaari--ja-muut-asiantuntijaesitelmät-ja--luennot)
    * [Opinnäytteet](#opinnäytteet)
    * [Televisio- ja radio-ohjelmat, podcastit ja elokuvat](#televisio--ja-radio-ohjelmat-podcastit-ja-elokuvat)
...
### Report - Opinnäytteet
- vaihtoehdon Department alle voi kirjata tutkinto-ohjelman tai yksikön, esim: "Palveluliiketoiminnan tutkinto-ohjelma"
- vaihtoehdon ThesisType eteen myös julkaisun tiedot, jos oleellinen; esimerkki kirjallisen raportoinnin oppaasta:
- - "Sosiaalitieteiden laitoksen julkaisuja 2012:18. Väitöskirja"

### Film - Televisio- ja radio-ohjelmat, podcastit ja elokuvat
- vaihtoehto ProducerName käytetään vain jos kyseessä on esim podcasti joka ei ole isomman yrityksen tuottama
- vaihtoehdon ShortTitle alle ohjelman nimi, esim "Kulttuuriykkönen"
- vaihtoehto Writer tarkoittaa tässä yhteydessä toimittajaa
- vaihtoehdon Performer alle kanava miltä ohjelma on tullut esim. "Yle" tai "Yle Radio 1"
- julkaisupäivä tulee vaihtoehdon StandardNumber alle
